...
#show: nudt-theme.with(
  ...
  config-info(
    title: [Typst Slide Theme for NUDT Based on Touying],
    subtitle: [基于 Touying 的国防科技大学 Typst 幻灯片模板],
    author: [yelpevade],
    date: datetime.today(),
    institution: [国防科技大学],
  ),
...
#slide[
  - 您可以使用：
    ```sh
    typst init @preview/touying-simpl-nudt
    ```
    来创建基于本模板的演示文稿项目。

  - 本模板仓库位于 #link("https://github.com/yelpevade/touying-nudt")，欢迎关注与贡献。
]
